                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="images/anh4.png" class="img-fluid">
                        </div>
                      </div>
                    </div>
        ...
        <div class="row">
          <div class="col-md-12">
           ...
           foreach($listdanhmuc as $danhmuc){
			$name = htmlspecialchars($danhmuc['name']); // Safely output product name
			extract($danhmuc);
			echo '
            ...
            <div class="bootstrap-tabs product-tabs">
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
                  ...
                  <di class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
...
if (is_array($listsanpham) && !empty($listsanpham)) {
                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="'.$img.'"  alt="' . $name . '"  class="tab-image">
                          </a>
                        </figure>
                        <h3>'.$name.'</h3>
    ...
    echo '</div></div>'; // End of Bootstrap row and container
} else {
    echo '<div class="container mt-4"><p>No products available.</p></div>'; // Handle case with no products
}
?>
    ...
    <section class="py-5">
      <div class="container-fluid">
        <div class="row">
		<div class="col-md-6">
    <div class="banner-ad bg-danger mb-3" style="background: url('images/anh3.jpg'); background-repeat: no-repeat; background-position: right bottom; background-size: 760px 300px;">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-5">
              ...
              <h2 class="section-title">Top 10 yêu thích</h2>
            ...
            <div class="products-carousel swiper">
              <div class="swiper-wrapper">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="'.$linksp.'" class="nav-link">Add to Cart <iconify-icon icon="uil:shopping-cart"></a>
                  </div>
                </div>';
                            }
                        ?>
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/laptop-4k-10.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/anh1.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/anh2.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
